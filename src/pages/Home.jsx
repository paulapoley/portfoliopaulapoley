...
const Home = () => {
  const projects = [
    { id: 1, title: 'Influencia de Variables Exógenas en la Detección de Enfermedades de Piel mediante Redes Neuronales y Análisis de Imágenes Médicas', imgSrc: '/pdfs/TFG-PAULAPOLEY.jpg', pdfSrc: '/pdfs/TFG-PAULAPOLEY.pdf' },
    ...
    { id: 7, title: 'BYODSEC: Implementación de BYOD en una Entidad Hospitalaria con VPN Road Warrior TLS', imgSrc: '/pdfs/p3.jpg', pdfSrc: '/pdfs/proyecto3.pdf' },
